...
mainDir <- "/Users/jonathantownson/Documents/PhD/Images/Analysed image data/Band assay/NDECDmSc vs R2007AmSca vs NICDmSca/NDECD"
setwd(mainDir)
# Load the background values
DF <- read.csv("/Users/jonathantownson/Documents/PhD/Images/Analysed image data/Band assay/NDECDmSc vs R2007AmSca vs NICDmSca/NDECD/Background NDECD values.csv", head = TRUE, sep = ",")
BackgroundValues <- data.frame(Nucleus=DF[,1], NDECDBG=rowMeans(DF[,-1]))
rm(DF)
# Create the path where the data is stored
DataPath <- "/Users/jonathantownson/Documents/PhD/Images/Analysed image data/Band assay/NDECDmSc vs R2007AmSca vs NICDmSca/NDECD/Selected Band assay csv files"
...
WTNDECDRDSepDates <- SepDates(NDECDRawData,"NΔECD")
WTNDECDminsixSubSepDates <- SepDates(NDECDminsixSub,"NΔECD")
...
RelIntNDECDSepDates <- (RelIntSepDates(RelIntNDECD,"NΔECD"))
...
RelIntNDECDBgSepDates <- RelIntSepDates(RelIntNDECDBg, "NΔECD")
...
RelIntNDECDBg0SepDates <- RelIntSepDates(RelIntNDECDBg0, "NΔECD")
...
RelIntNDECDBgSubSepDates <- RelIntSepDates(RelIntNDECDBgSub, "NΔECD")
...
RelIntNDECDMinSixSubSepDates <- RelIntSepDates(RelIntNDECDMinSixSub, "NΔECD")
...
RelIntChangeNDECDBgSepDates <- RelIntSepDates(RelIntChangeNDECDBg, "NΔECD")
...
RelIntChangeNDECDSepDates <- (RelIntSepDates(RelIntChangeNDECD, "NΔECD"))
#### end ####
...
Labs <- c(title = " ", x = "Distance (um)", y = "NICD::mScarlet Fluorescence (AU)")
df <- MeanGenotypesByDateRawData[[1]]
band_plot(df, Labs) + theme(legend.position = "bottom", legend.title = element_blank()) +
  scale_y_continuous(breaks = seq(500,2000, by = 300), limits = c(450,2050))
ggsave(paste(" RawData Band plot of ",names(MeanGenotypesByDateRawData)[1],".jpg"), device = "jpeg", dpi = "retina",
       width = 12, height = 12, units = "cm")

Labs <- c(title = " ", x = "Distance (um)", y = "NICD::mScarlet Fluorescence (AU)")
df <- MeanGenotypesByDateRawData[[2]]
band_plot(df, Labs) + theme(legend.position = "bottom", legend.title = element_blank()) +
  scale_y_continuous(breaks = seq(700,1300, by = 100), limits = c(700,1300))
ggsave(paste(" RawData Band plot of ",names(MeanGenotypesByDateRawData)[2],".jpg"), device = "jpeg", dpi = "retina",
       width = 12, height = 12, units = "cm")
...
for (p in 1:length(RelIntNDECDSepDates)) {
  ...
  RelInt_crossbar(df, Labs) + theme(legend.position = "none") +
    geom_signif(comparisons = list(c(names(RelIntNDECDSepDates)[p],"NΔECD")), 
                map_signif_level=TRUE, test = "t.test", color = "black", y_position = 1.55) +
    scale_y_continuous(breaks = seq(1, 1.6, by = 0.1), limits = c(1,1.6))
...
for (p in 1:length(RelIntNDECDBgSepDates)) {
  ...
  RelInt_crossbar(df, Labs) + theme(legend.position = "none") +
    geom_signif(comparisons = list(c(names(RelIntNDECDBgSepDates)[p],"NΔECD")), 
...
for (p in 1:length(RelIntNDECDBg0SepDates)) {
  ...
  RelInt_crossbar(df, Labs) + theme(legend.position = "none") +
    geom_signif(comparisons = list(c(names(RelIntNDECDBg0SepDates)[p],"NΔECD")), 
                map_signif_level=TRUE, test = "t.test", color = "black")
...
for (p in 1:length(RelIntChangeNDECDSepDates)) {
  ...
  RelInt_crossbar(df, Labs) + theme(legend.position = "none") +
    geom_signif(comparisons = list(c(names(RelIntChangeNDECDSepDates)[p],"NΔECD")), 
                map_signif_level=TRUE, test = "t.test", color = "black", y_position = 0.55) +
...
for (p in 1:length(RelIntChangeNDECDBgSepDates)) {
  ...
  RelInt_crossbar(df, Labs) + theme(legend.position = "none") +
    geom_signif(comparisons = list(c(names(RelIntChangeNDECDBgSepDates)[p],"NΔECD")), 
                map_signif_level=TRUE, test = "t.test", color = "black")
...
for (p in 1:length(RelIntNDECDBgSubSepDates)) {
  ...
  RelInt_crossbar(df, Labs) + theme(legend.position = "none") +
    geom_signif(comparisons = list(c(names(RelIntNDECDBgSubSepDates)[p],"NΔECD")), 
                map_signif_level=TRUE, test = "t.test", color = "black")
...
for (p in 1:length(RelIntNDECDMinSixSubSepDates)) {
  ...
  RelInt_crossbar(df, Labs) + theme(legend.position = "none") +
    geom_signif(comparisons = list(c(names(RelIntNDECDMinSixSubSepDates)[p],"NΔECD")), 
                map_signif_level=TRUE, test = "wilcox.test", color = "black", y_position = 550) +
