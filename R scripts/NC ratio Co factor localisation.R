...
SuHdata <- dplyr::select(SuHdata,c("Cell","Nucleus Area","Nucleus Mean","Cytoplasm Area","Cytoplasm Mean","NCratio","NuclearPercent","NuclearRelativeChange","Gland","IncubationTime"))
...
NECDmCherryNICD <- SuHdata %>% dplyr::filter(IncubationTime == "NECDmCherryNICD")
#### end ####
...
NuclearPercent_crossbar <- function(Data, Labels) {
  ggplot(Data,aes(IncubationTime,NuclearPercent,col=IncubationTime,shape=IncubationTime)) + theme_jmt() +
    geom_jitter(width=0.25) +
    stat_summary(fun="mean", geom="crossbar", width=0.5) + theme(legend.key=element_blank())  + 
    labs(title = Labels[[1]], x = Labels[[2]], y = Labels[[3]]) + 
    scale_color_brewer(palette = "Set2")
}
NuclearRelativeChange_crossbar <- function(Data, Labels) {
  ggplot(Data,aes(IncubationTime,NuclearRelativeChange,col=IncubationTime,shape=IncubationTime)) + theme_jmt() +
    geom_jitter(width=0.25) +
    stat_summary(fun="mean", geom="crossbar", width=0.5) + theme(legend.key=element_blank())  + 
    labs(title = Labels[[1]], x = Labels[[2]], y = Labels[[3]]) + 
    scale_color_brewer(palette = "Set2")
...
NCratio_crossbar(df1, Labs) + theme(axis.title.x=element_blank(), legend.position = "bottom", legend.title = element_blank()) + 
  guides(colour = guide_legend(nrow=2, byrow = TRUE)) +
  geom_signif(comparisons = list(c("4ALEA4","wtNDECDmScarlet")),y_position = 6, 
              map_signif_level=TRUE, test = "t.test", color = "black") +
  geom_signif(comparisons = list(c("4ALEA4","EAAAKA")), y_position = 5.5,
              map_signif_level=TRUE, test = "t.test", color = "black") +
...
NCratio_crossbar(df1, Labs) + theme(axis.title.x=element_blank(), legend.position = "bottom", legend.title = element_blank()) + 
  guides(colour = guide_legend(nrow=2, byrow = TRUE)) +
  geom_signif(comparisons = list(c("OldBLITz","wtNDECDmScarlet")),y_position = 5, 
              map_signif_level=TRUE, test = "t.test", color = "black")
...
NCratio_crossbar(df1, Labs) + theme(axis.title.x=element_blank(), legend.position = "bottom", legend.title = element_blank()) + 
  guides(colour = guide_legend(nrow=2, byrow = TRUE)) +
  geom_signif(comparisons = list(c("CD8 TEV mCherry NICD","wtNDECDmScarlet")),y_position = 5, 
              map_signif_level=TRUE, test = "t.test", color = "black")
ggsave(paste("CD8 TEV vs WT NCratio of",CoFactor,".jpg"), device = "jpeg", dpi = "retina",
       width = 15, height = 15, units = "cm")

df1 <- rbind(NewBLITzDark,NewBLITzLight)
Labs <- c(title = "", x = "Incubation Time", y = paste("Nuclear fluorescence of",CoFactor," (AU"))
NucleusMean_crossbar(df1, Labs) + theme(axis.title.x=element_blank(), legend.position = "bottom", legend.title = element_blank()) + 
  guides(colour = guide_legend(nrow=2, byrow = TRUE)) +
  geom_signif(comparisons = list(c("NewBLITz kept in dark","NewBLITz kept in light")),y_position = 400, 
              map_signif_level=TRUE, test = "t.test", color = "black")
ggsave(paste("NewBLITz kept in dark vs light Nucleus Mean of",CoFactor,".jpg"), device = "jpeg", dpi = "retina",
       width = 15, height = 15, units = "cm")
...
DataStatSumTestListFun(SuHRawData,paste("Summary of",CoFactor))
...
NCratio_crossbar(df1, Labs) + theme(axis.title.x=element_blank(), legend.position = "none") + 
  guides(colour = guide_legend(nrow=2, byrow = TRUE)) +
...
df1 <- rbind(ALEA,EAAAKA,WT,OldBLITz,CD8,NECDmCherryNICD)
Labs <- c(title = "", x = "Incubation Time", y = paste("Nuclear mean of",CoFactorLabel))
NucleusMean_crossbar(df1, Labs) + theme(axis.title.x=element_blank(), legend.position = "none") + 
  guides(colour = guide_legend(nrow=2, byrow = TRUE)) +
  geom_signif(comparisons = list(c("4ALEA4","wtNDECDmScarlet")),y_position = 750, 
              map_signif_level=TRUE, test = "t.test", color = "black") +
  geom_signif(comparisons = list(c("EAAAKA","wtNDECDmScarlet")), y_position = 700,
              map_signif_level=TRUE, test = "t.test", color = "black") +
  geom_signif(comparisons = list(c("OldBLITz","wtNDECDmScarlet")),y_position = 900, 
              map_signif_level=TRUE, test = "t.test", color = "black") +
  geom_signif(comparisons = list(c("CD8 TEV mCherry NICD","wtNDECDmScarlet")),y_position = 850, 
              map_signif_level=TRUE, test = "t.test", color = "black") +
  geom_signif(comparisons = list(c("CD8 TEV mCherry NICD","OldBLITz")),y_position = 700, 
              map_signif_level=TRUE, test = "t.test", color = "black") +
  geom_signif(comparisons = list(c("NECDmCherryNICD","wtNDECDmScarlet")), y_position = 800,
              map_signif_level=TRUE, test = "t.test", color = "black")
ggsave(paste("WT vs original linkers Nuclear Mean of",CoFactor,".jpg"), device = "jpeg", dpi = "retina",
       width = 15, height = 15, units = "cm")

df1 <- rbind(ALEA,EAAAKA,WT,OldBLITz,CD8,NECDmCherryNICD)
Labs <- c(title = "", x = "Incubation Time", y = paste("Cytoplasmic mean of",CoFactorLabel))
CytoplasmMean_crossbar(df1, Labs) + theme(axis.title.x=element_blank(), legend.position = "none") + 
  guides(colour = guide_legend(nrow=2, byrow = TRUE)) +
  geom_signif(comparisons = list(c("4ALEA4","wtNDECDmScarlet")),y_position = 350, 
              map_signif_level=TRUE, test = "t.test", color = "black") +
  geom_signif(comparisons = list(c("EAAAKA","wtNDECDmScarlet")), y_position = 300,
              map_signif_level=TRUE, test = "t.test", color = "black") +
  geom_signif(comparisons = list(c("OldBLITz","wtNDECDmScarlet")),y_position = 500, 
              map_signif_level=TRUE, test = "t.test", color = "black") +
  geom_signif(comparisons = list(c("CD8 TEV mCherry NICD","wtNDECDmScarlet")),y_position = 450, 
              map_signif_level=TRUE, test = "t.test", color = "black") +
  geom_signif(comparisons = list(c("CD8 TEV mCherry NICD","OldBLITz")),y_position = 300, 
              map_signif_level=TRUE, test = "t.test", color = "black") +
  geom_signif(comparisons = list(c("NECDmCherryNICD","wtNDECDmScarlet")), y_position = 400,
              map_signif_level=TRUE, test = "t.test", color = "black")
ggsave(paste("WT vs original linkers Cytoplasm Mean of",CoFactor,".jpg"), device = "jpeg", dpi = "retina",
       width = 15, height = 15, units = "cm")
...
NCratio_crossbar(df1, Labs) + theme(axis.title.x=element_blank(), legend.position = "none") + 
  ...
  geom_signif(comparisons = list(c("EAAAKA","wtNDECDmScarlet")), y_position = 5,
              map_signif_level=TRUE, test = "t.test", color = "black") +
  geom_signif(comparisons = list(c("OldBLITz","wtNDECDmScarlet")),y_position = 7, 
              map_signif_level=TRUE, test = "t.test", color = "black") +
  geom_signif(comparisons = list(c("CD8 TEV mCherry NICD","wtNDECDmScarlet")),y_position = 6.5, 
              map_signif_level=TRUE, test = "t.test", color = "black") +
  geom_signif(comparisons = list(c("CD8 TEV mCherry NICD","OldBLITz")),y_position = 2, 
              map_signif_level=TRUE, test = "t.test", color = "black") +
  geom_signif(comparisons = list(c("NECDmCherryNICD","wtNDECDmScarlet")), y_position = 6,
              map_signif_level=TRUE, test = "t.test", color = "black")
ggsave(paste("WT vs original linkers NC ratio Mean of",CoFactor,".jpg"), device = "jpeg", dpi = "retina",
       width = 15, height = 15, units = "cm")

df1 <- rbind(ALEA,EAAAKA,WT,OldBLITz,CD8,NECDmCherryNICD)
Labs <- c(title = "", x = "Incubation Time", y = paste("Nuclear percent of",CoFactorLabel))
NuclearPercent_crossbar(df1, Labs) + theme(axis.title.x=element_blank(), legend.position = "none") + 
  guides(colour = guide_legend(nrow=2, byrow = TRUE)) +
  geom_signif(comparisons = list(c("4ALEA4","wtNDECDmScarlet")),y_position = 80, 
              map_signif_level=TRUE, test = "t.test", color = "black") +
  geom_signif(comparisons = list(c("EAAAKA","wtNDECDmScarlet")), y_position = 75,
              map_signif_level=TRUE, test = "t.test", color = "black") +
  geom_signif(comparisons = list(c("OldBLITz","wtNDECDmScarlet")),y_position = 95, 
              map_signif_level=TRUE, test = "t.test", color = "black") +
  geom_signif(comparisons = list(c("CD8 TEV mCherry NICD","wtNDECDmScarlet")),y_position = 90, 
              map_signif_level=TRUE, test = "t.test", color = "black") +
  geom_signif(comparisons = list(c("CD8 TEV mCherry NICD","OldBLITz")),y_position = 85, 
              map_signif_level=TRUE, test = "t.test", color = "black") +
  geom_signif(comparisons = list(c("NECDmCherryNICD","wtNDECDmScarlet")), y_position = 85,
              map_signif_level=TRUE, test = "t.test", color = "black")
ggsave(paste("WT vs original linkers Nuclear percent of",CoFactor,".jpg"), device = "jpeg", dpi = "retina",
       width = 15, height = 15, units = "cm")

df1 <- rbind(ALEA,EAAAKA,WT,OldBLITz,CD8,NECDmCherryNICD)
Labs <- c(title = "", x = "Incubation Time", y = paste("Nuclear:Cytoplasmic ratio of",CoFactorLabel))
NuclearRelativeChange_crossbar(df1, Labs) + theme(axis.title.x=element_blank(), legend.position = "none") + 
  guides(colour = guide_legend(nrow=2, byrow = TRUE)) +
  geom_signif(comparisons = list(c("4ALEA4","wtNDECDmScarlet")),y_position = 5.5, 
              map_signif_level=TRUE, test = "t.test", color = "black") +
  geom_signif(comparisons = list(c("4ALEA4","EAAAKA")), y_position = 4,
  ...
  geom_signif(comparisons = list(c("NECDmCherryNICD","wtNDECDmScarlet")), y_position = 6,
              map_signif_level=TRUE, test = "t.test", color = "black")
ggsave(paste("WT vs original linkers Nuclear Relative change of",CoFactor,".jpg"), device = "jpeg", dpi = "retina",
       width = 15, height = 15, units = "cm")
setwd(mainDir)
#### end ####

df1 <- rbind(ALEA,EAAAKA,WT,OldBLITz,CD8)
Labs <- c(title = "", x = "Incubation Time", y = paste("Nuclear",CoFactor))
NucleusMean_crossbar(df1, Labs) + theme(axis.title.x=element_blank(), legend.position = "bottom", legend.title = element_blank()) + 
  guides(colour = guide_legend(nrow=2, byrow = TRUE)) +
  geom_signif(comparisons = list(c("4ALEA4","wtNDECDmScarlet")),y_position = 5.5, 
              map_signif_level=TRUE, test = "t.test", color = "black") +
